        ...
        button.addEventListener("click", ()=>{
                ...
                button.addEventListener("click", ()=> {
                    if(numMain.innerText != ""){
                        if(numSecondary.innerText != ""){
                            numSecondary.innerText = `${parseFloat(numMain.innerText) + parseFloat(numSecondary.innerText)} ${button.innerText}`;
                        }else{
            ...
            case "/":
                button.addEventListener("click", ()=> {
                    if(numMain.innerText != ""){
                        if(numSecondary.innerText != ""){
                            numSecondary.innerText = `${parseFloat(numSecondary.innerText) / parseFloat(numMain.innerText)} ${button.innerText}`;
                        }else{
                            numSecondary.innerText = `${numMain.innerText} ${button.innerText}`;
                        }    
                        numMain.innerText = "";
            ...
            case "=":
                button.addEventListener("click", ()=>{  
                    ...
                    switch(currentOperation){
                        case "+":
                            numMain.innerHTML = parseFloat(numMain.innerHTML) + parseFloat(numSecondary.innerText);
                            numSecondary.innerText = "";
                            newOperation = true;
                            break;
                        case "-":
                        ...
                        case "*":
                            ...
                            break;
                        case "/":
                            numMain.innerHTML = parseFloat(numSecondary.innerText) / parseFloat(numMain.innerHTML) ;
                            numSecondary.innerText = "";
                            newOperation = true;
                            break;
                        case "%":
